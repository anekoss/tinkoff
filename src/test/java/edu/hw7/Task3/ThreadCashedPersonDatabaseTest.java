...
public class ThreadCashedPersonDatabaseTest {
    ...
    void addPersonToCashedDatabaseTest(Person person) throws InterruptedException {
    ...
    @ParameterizedTest
    @MethodSource("provideDataForTest")
    void deletePersonFromCashedDatabaseTest(Person person) throws InterruptedException {
