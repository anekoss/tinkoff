...
public class PersonDatabaseWithReadWriteLockTest {
    ...
    void addPersonToDatabaseTest(
        ...
        assertThat(database.getPersonDatabase()).isEqualTo(personDatabase);
        assertThat(database.getAddressIndex()).isEqualTo(addressIndex);
        assertThat(database.getNameIndex()).isEqualTo(nameIndex);
        assertThat(database.getPhoneIndex()).isEqualTo(phoneIndex);
    }
    ...
    void deletePersonToDatabaseTest(
        ...
        assertThat(database.getPersonDatabase()).isEmpty();
        assertThat(database.getAddressIndex()).isEmpty();
        assertThat(database.getNameIndex()).isEmpty();
        assertThat(database.getPhoneIndex()).isEmpty();
    }
    ...
    void findPersonTest(
        ...
        for (Person person : personList) {
            assertThat(database.findByName(person.name())).isEqualTo(nameIndex.get(person.name()));
            assertThat(database.findByAddress(person.address())).isEqualTo(addressIndex.get(person.address()));
            assertThat(database.findByPhone(person.phoneNumber())).isEqualTo(phoneIndex.get(person.phoneNumber()));
        }
    }
