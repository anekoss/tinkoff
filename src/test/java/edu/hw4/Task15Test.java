...
public class Task15Test {
    ...
    void getSumWeightTypeAnimalTest(List<Animal> animals, int k, int l, Map<Animal.Type, Integer> excepted)
        throws NullAnimalListException, NullAnimalException {
        assertThat(getSumWeightTypeAnimal(animals, k, l)).isEqualTo(excepted);
    }
