...
import static edu.hw4.Task1_18.Task1To18.getAgeNoEqualsCntPawsAnimals;
...
public class Task10Test {
    public static Stream<Arguments> provideDataForTest() {
        return Stream.of(
            ...
            Arguments.of(
                List.of(
                    new Animal("a", Animal.Type.CAT, Animal.Sex.M, 4, 13, 100, true),
    ...
    void getAgeNoEqualsCntPawsTest(List<Animal> animals, List<Animal> excepted)
        throws NullAnimalListException, NullAnimalException {
        assertThat(getAgeNoEqualsCntPawsAnimals(animals)).isEqualTo(excepted);
    }

    @ParameterizedTest
    @MethodSource("provideDataForExceptionTest")
    void getAgeNoEqualsCntPawsExceptionTest(List<Animal> animals, Class<Exception> excepted) {
        assertThrows(excepted, () -> getAgeNoEqualsCntPawsAnimals(animals));
    }
