...
import static edu.hw4.Task1_18.Task1To18.sortAnimalsByWeight;
...
public class Task2Test {
    ...
    void sortAnimalsByWeightExceptionTest(List<Animal> animals, Class<Exception> exceptedException) {
        int k = 5;
